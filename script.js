...
easy.onclick = function () {
	speed = 3;
	easy.style.boxShadow = ' 0px 0px 20px 6px yellow';
	medium.style.boxShadow = ' 0px 0px 0px 0px yellow';
	hard.style.boxShadow = ' 0px 0px 0px 0px yellow';
	document.getElementById('check').play();
}
medium.onclick = function () {
	speed = 2;
	medium.style.boxShadow = ' 0px 0px 20px 6px yellow';
	easy.style.boxShadow = ' 0px 0px 0px 0px yellow';
	hard.style.boxShadow = ' 0px 0px 0px 0px yellow';
	document.getElementById('check').play();
}
hard.onclick = function () {
	speed = 1;
	hard.style.boxShadow = ' 0px 0px 20px 6px yellow';
	medium.style.boxShadow = ' 0px 0px 0px 0px yellow';
	easy.style.boxShadow = ' 0px 0px 0px 0px yellow';
	document.getElementById('check').play();
}
...
mute.onclick = function mut() {
	...
	document.getElementById('muteVol').src = isMuted ? './img/vol.png' : './img/mute.png';
};
//soundsVolume
